...
use R2Offload\Vendor\Aws\Exception\UnresolvedApiException;
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \R2Offload\Vendor\Aws\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \R2Offload\Vendor\Aws\load_compiled_json($path);
