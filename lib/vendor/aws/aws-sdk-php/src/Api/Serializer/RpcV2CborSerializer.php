...
use R2Offload\Vendor\Aws\Api\Cbor\CborEncoder;
use R2Offload\Vendor\Aws\Api\Cbor\Exception\CborException;
use R2Offload\Vendor\Aws\Api\Exception\RpcV2CborException;
