...
use R2Offload\Vendor\Aws\Arn\S3\AccessPointArn as S3AccessPointArn;
use R2Offload\Vendor\Aws\Arn\ObjectLambdaAccessPointArn;
use R2Offload\Vendor\Aws\Arn\S3\MultiRegionAccessPointArn;
use R2Offload\Vendor\Aws\Arn\S3\OutpostsBucketArn;
use R2Offload\Vendor\Aws\Arn\S3\RegionalBucketArn;
