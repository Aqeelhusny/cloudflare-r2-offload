...
namespace R2Offload\Vendor\Aws\Configuration;
...
class ConfigurationResolver
{
    ...
    {
        if ($type === 'bool'
            && !is_null($convertedValue = \R2Offload\Vendor\Aws\boolean_value($value))
        ) {
    ...
    private static function retrieveValueFromIniSubsection(
        ...
        $services_section = \R2Offload\Vendor\Aws\parse_ini_section_with_subsections(
            $filename,
